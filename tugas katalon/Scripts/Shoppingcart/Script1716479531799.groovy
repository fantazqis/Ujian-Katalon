...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/span_1'))
...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Swag Labs/span_Checkout Overview'))
